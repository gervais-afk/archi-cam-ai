        ...
        <div className="sticky top-16 z-30 px-4 sm:px-6 lg:px-8 py-3">
          <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between bg-anthracite-900/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-xl">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-white font-bold tracking-wide">Studio Archi IA (BIM Pro)</span>
            </div>
            ...
            <div className="hidden sm:flex items-center gap-0 p-1 bg-black/30 rounded-xl border border-white/10">
              ...
              <div
                className="flex items-center gap-2 px-4 py-1.5 rounded-lg text-xs font-black uppercase tracking-widest transition-all duration-300 bg-gradient-to-r from-ai-glow/20 to-ai-glow/10 text-ai-glow border border-ai-glow/30 shadow-lg shadow-ai-glow/10"
              >
                ...
                <div className="animate-fade-in flex items-end justify-between">
                  <div>
                    <h1 className="font-display font-black text-white text-3xl tracking-tight">
                      Projet Professionnel <span className="text-transparent bg-clip-text bg-gradient-to-r from-ai-glow to-ai-glow/50">(BIM)</span>
                    </h1>
