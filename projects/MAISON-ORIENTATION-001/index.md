...
metadata:
  ...
  total_budget_fcfa: 7209136
  bioclimatic_score: "A+"
  number_of_floors: "R+1"
...
# 🏛️ INDEX PROJET OKF v0.2 — DUPLEX R+1 CONTEMPORAIN — MAISON D'ORIENTATION

- **Client** : Koa Marie Gervais Nelly
- **Surface Totale Utile** : 95.28 m²
- **Budget Global HT** : 7 209 136 FCFA
- **Note Bioclimatique** : A+ (Matériaux Locaux MIPROMALO & Pierre d'Edéa)
